    ...
    <>
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-end bg-black overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://swigs.online/uploads/grecoautogroup/1777645476877-560229356.webp" alt="Greco Autogroup" className="w-full h-full object-cover" style={{ objectPosition: 'center 60%' }} />
