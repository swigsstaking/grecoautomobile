...
const NotreHistoireV3 = () => {
  return (
    <>
      ...
      <section className="bg-[#0d1117] py-20 md:py-32">
        <div className="max-w-[1920px] mx-auto px-6 md:px-12 lg:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32">
            <div>
              <p className="text-white/30 text-xs uppercase tracking-[0.3em] mb-6">Notre mission</p>
              <h2 className="text-4xl md:text-5xl font-display font-bold text-white leading-[0.95]">
            ...
            <div className="lg:pt-4">
              <div className="space-y-6 text-white/50 text-lg font-light leading-relaxed">
                <p>
                  Greco Autogroup est né de la conviction qu'acheter ou vendre un véhicule
                  devrait être une expérience simple, transparente et agréable.
                </p>
                <p>
                  Notre fondateur, passionné d'automobile depuis son plus jeune âge, a souhaité
                  créer un espace où chaque client se sent écouté, conseillé et accompagné.
                </p>
                <p>
                  Aujourd'hui, nous continuons avec la même philosophie : des véhicules de qualité
                  à des prix justes, avec un service humain et personnalisé.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#0d1117] py-20 md:py-32">
        <div className="max-w-[1920px] mx-auto px-6 md:px-12 lg:px-24">
          <p className="text-white/30 text-xs uppercase tracking-[0.3em] mb-16">Notre parcours</p>
          ...
          <div className="space-y-24 md:space-y-32">
            {[
              ...
              >
                <div>
                  <p className="text-white/20 text-xs uppercase tracking-[0.3em] mb-4">{item.period}</p>
                  <h3 className="text-3xl md:text-4xl font-display font-bold text-white leading-[0.95] mb-6">
                    {item.title}
                  </h3>
      ...
      <section className="bg-[#0d1117] border-t border-white/5 py-20 md:py-32">
        <div className="max-w-[1920px] mx-auto px-6 md:px-12 lg:px-24">
          <p className="text-white/30 text-xs uppercase tracking-[0.3em] mb-4">Ce qui nous définit</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/5">
            {[
              ...
              <div key={i} className="bg-[#0d1117] p-8 md:p-10">
                <span className="text-white/10 text-6xl font-display font-bold leading-none">0{i + 1}</span>
                <h3 className="text-xl font-display font-bold text-white mt-4 mb-3">{value.title}</h3>
...
export default NotreHistoireV3;
